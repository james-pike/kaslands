  ...
  return (
    <>
      ...
      <header
        id="header"
        class={`
          sticky top-0 z-40 mt-0 flex-none mx-[6px] md:mx-auto max-w-6xl rounded-t-lg
      ...
      >
        ...
        <div class="relative text-default py-1 pb-1 md:p-1 px-1 md:px-6 mx-auto w-full md:flex md:items-center max-w-7xl">
          {/* Logo Section */}
